...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-4 sm:px-6 md:px-8 overflow-hidden bg-white">
      ...
      <motion.h1
        className="font-bold text-4xl sm:text-5xl md:text-6xl mb-10 md:mb-16 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"
        variants={fadeUp}
        initial="hidden"
        whileInView="visible"
      ...
      <motion.div
        className="mt-10 md:mt-12 flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8"
        variants={fadeUp}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: false, amount: 0.5 }}
      ...
      <div className="absolute bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 text-4xl md:text-6xl text-muted-foreground hover:text-slate-700">
        ↓
      </div>
    </section>
  );
